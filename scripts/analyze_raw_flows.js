...
const KNOWN_DEVICES = new Set(['10.255.0.1', '10.255.0.2', '10.255.0.3']);
...
rl.on('close', () => {
  ...
  console.log(`触及已知设备(10.255.0.1/10.255.0.2/10.255.0.3)的流: ${deviceTouching} (${(deviceTouching / rows * 100).toFixed(1)}%)`);
